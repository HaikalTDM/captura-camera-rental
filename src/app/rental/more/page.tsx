    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-black text-white pt-16 pb-8 px-6">
        <div className="max-w-lg mx-auto">
          <h1 className="text-2xl font-black mb-2">More</h1>
      ...
      <section className="py-8 px-6">
        <div className="max-w-lg mx-auto">
          <h2 className="text-lg font-black text-black mb-4">Quick Contact</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            {quickActions.map((action, index) => (
              <button
                ...
                className={`bg-gradient-to-br ${action.color} text-white rounded-2xl p-6 hover:scale-105 transition-all duration-300 active:scale-95 shadow-lg`}
              >
      ...
      {menuSections.map((section, sectionIndex) => (
        <section key={sectionIndex} className="py-8 px-6 bg-white">
          <div className="max-w-lg mx-auto">
            <h2 className="text-lg font-black text-black mb-4">{section.title}</h2>
            ...
            <div className="space-y-3">
              {section.items.map((item, itemIndex) => (
                <button
                  ...
                  className="w-full bg-slate-50 hover:bg-slate-100 rounded-2xl p-4 transition-all duration-300 active:scale-98 border-2 border-slate-200 hover:border-slate-300 group"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 text-left">
                      <div className="text-base font-black text-black mb-0.5">{item.label}</div>
                      <div className="text-xs text-slate-600 font-semibold">{item.description}</div>
                    </div>
      ...
      <section className="py-8 px-6">
        <div className="max-w-lg mx-auto">
          <div className="bg-gradient-to-br from-slate-900 to-black text-white rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-black">CAPTURA</h3>
                <p className="text-xs text-slate-400 font-semibold">Premium Camera Rentals</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              <div className="text-center">
                ...
                <div className="text-xs text-slate-400 font-bold">Customers</div>
              </div>
              <div className="text-center">
