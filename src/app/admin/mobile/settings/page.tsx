      ...
      items: [
        {
          ...
          sublabel: 'Manage customer accounts',
      ...
      items: [
        {
          ...
          sublabel: 'Update your account details',
          href: '/admin/profile',
          icon: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="px-4 pt-4 pb-24 space-y-5">
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-3 flex-1 min-w-0">
              <div className={`w-12 h-12 ${
                isDarkMode ? 'bg-slate-800 border-slate-700 group-hover:bg-slate-700' : 'bg-slate-100 border-slate-300 group-hover:bg-slate-200'
        ...
        {settingsSections.map((section, sectionIndex) => (
          <div key={sectionIndex} className="space-y-3 animate-fadeIn" style={{ animationDelay: `${sectionIndex * 50}ms` }}>
            ...
            <h3 className={`text-xs font-bold uppercase tracking-wider px-2 ${
              ...
              {section.items.map((item, itemIndex) => {
                const content = (
                  <>
                    ...
                    {item.isToggle ? (
                      <div 
                        className={`relative w-12 h-7 rounded-full transition-all duration-300 ease-out flex-shrink-0 ${
                          item.value 
        ...
        <div className="text-center py-8 animate-fadeIn" style={{ animationDelay: '300ms' }}>
          ...
          <div className={`inline-flex items-center justify-center gap-2.5 px-5 py-2.5 rounded-full ${
            isDarkMode ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'
