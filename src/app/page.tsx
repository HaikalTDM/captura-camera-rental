        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Explore our comprehensive guides and resources to make your rental experience seamless.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Equipment Specs</h3>
              <p className="text-gray-600 text-sm">Detailed specifications & accessories</p>
            </a>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Customer Gallery</h3>
              <p className="text-gray-600 text-sm">See amazing customer creations</p>
            </a>
