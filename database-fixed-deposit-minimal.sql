-- CAPTURA Fixed Deposit Payment System - Minimal Update
...
-- Step 4: Show updated camera deposit amounts (optional verification)
-- SELECT name, deposit_amount FROM cameras ORDER BY name;

-- Step 5: Show new booking columns (optional verification)
